...
public class ProductOrderPage {
  ...
  private   WebElement productName;
    ...
    public  void sendAddressInformation(String customerName, String street,
...
public String getSuccessMessage(){
   return    BrowserUtils.getTextMethod(message);
    ...
    public void productInfo(String customerName,String productName, String quantity, String street,
